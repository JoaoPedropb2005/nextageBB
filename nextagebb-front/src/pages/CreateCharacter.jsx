...
export default function CreateCharacter() {
    ...
    const handleSearchGames = async () => {
        ...
        } catch (err) { alert("Erro ao buscar jogos."); } 
        finally { setIsSearching(false); }
    };

    const handleSelectGame = (game) => {
        setGameIdApi(game.id); setGameName(game.name); setGameImage(game.background_image);
        setSearchResults([]); setGameSearch('');
    };
    ...
    const handleSubmit = async (e) => {
        ...
        formData.append('name', name); formData.append('characterClass', characterClass);
        formData.append('race', race); formData.append('role', role);
        formData.append('gameIdApi', gameIdApi); formData.append('gameName', gameName); formData.append('gameImage', gameImage);
